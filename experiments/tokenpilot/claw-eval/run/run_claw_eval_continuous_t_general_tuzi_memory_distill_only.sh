...
KUAIPAO_BASE_URL="${KUAIPAO_BASE_URL:-https://api.openai.com/v1}"
...
TOKENPILOT_MEMORY_DISTILL_BASE_URL="${TOKENPILOT_MEMORY_DISTILL_BASE_URL:-${TOKENPILOT_TASK_STATE_ESTIMATOR_BASE_URL:-https://api.openai.com/v1}}" \
